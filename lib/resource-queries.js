...
const getResourceQueries = (
  ...
  const loaderOptions = {
    ...
    '@mole-inc/lqip-loader': getLqipLoaderOptions(moduleConfig),
    'responsive-loader': getResponsiveLoaderOptions(moduleConfig, detectLoaders),
    '@mole-inc/sqip-loader': getSqipLoaderOptions(moduleConfig, detectLoaders)
  }
